...
public class Main {
    ...
    static void menuUser() throws IOException{
        ...
        while (loop){
            ...
            switch (menu1){
                case 1:
                    Pengguna pesan = new MenuPengguna();
                    pesan.caraPesan();
                    System.out.println("\nTekan [ENTER] untuk melanjutkan");
                    pause.nextLine();
                    break;
                case 2:
                    Pengguna seeBarang = new MenuPengguna();
                    seeBarang.lihat();
                    break;
                case 3 :
                    System.out.println("\nLogout Berhasil");
    ...
    public static void main (String[] args) throws NumberFormatException, IOException{
        ...
        ArrayList<Akun> DataUser = new ArrayList<>();
            DataUser.add(new Akun("eko", "123"));
        while(true){
            System.out.println("|=============================|");
            ...
            switch(select){
                case 1:
                    ...
                    Akun new_user = new Akun(username, password);
